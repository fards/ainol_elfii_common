...
#define I2C_MASTER_A_START  P_I2C_M_0_CONTROL_REG
#define I2C_MASTER_A_END      (P_I2C_M_0_RDATA_REG1-1)
#define I2C_MASTER_B_START  P_I2C_M_1_CONTROL_REG
#define I2C_MASTER_B_END      (P_I2C_M_1_RDATA_REG1-1)
#define I2C_SLAVE_START         P_I2C_S_CONTROL_REG
#define I2C_SLAVE_END             (P_I2C_S_CNTL1_REG-1)
#endif
